 ...
 * swipe left
 */
class PreviousItemGesture(
    resources: Resources,
    gestureNavigator: GestureNavigator,
) : GestureMenu {

    override val position = GesturePosition.GESTURE_PREVIOUS_ITEM.ordinal

    override var title = resources.getString(R.string.gesture_previous_item_title)
